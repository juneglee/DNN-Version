...
from detectron2.modeling.backbone.fpn import build_resnet_backbone
...
if __name__ == "__main__":
    ...
    # print(data.shape)
    image = cv2.imread("../assert/input/test.jpg", cv2.IMREAD_ANYCOLOR)
    height, width, channel = image.shape
    # print(height, width, channel)
    backbone = build_resnet_backbone(cfg, input_shape=image.shape)
    print(backbone)
    #
    # if args.input:
    #     if len(args.input) == 1:
